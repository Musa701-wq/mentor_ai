...
import 'generateDocQuizScreen.dart';
          ...
          child: Column(
            children: [
              ...
              _OptionCard(
                ...
                subtitle: "AI will create a quiz from your saved notes",
              ...
              _OptionCard(
                ...
                subtitle: "Upload a PDF or Image to create an AI quiz",
                icon: Icons.upload_file_rounded,
                colors: [Colors.orangeAccent, Colors.deepOrange],
                onTap: () {
                  AdService.showInterstitialAndNavigate(context, const GenerateDocQuizScreen());
                },
              ),
            ],
          ),
