...
class _SyllabusBreakdownScreenState extends State<SyllabusBreakdownScreen> {
  File? _selectedFile;
  int? _expandedIndex; // Tracks which timeline item is expanded
    ...
    return Scaffold(
      ...
      body: provider.isLoading
          ...
          : provider.roadmap != null
              ? _buildRoadmapView(provider.roadmap!, isDark)
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Our AI is analyzing the curriculum structure...',
  ...
  Widget _buildRoadmapView(Map<String, dynamic> data, bool isDark) {
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: isDark 
                ? [const Color(0xFF323264), const Color(0xFF4A47A3)] 
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Icon(Icons.workspace_premium_rounded, color: Colors.white70, size: 20),
                ],
              ),
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _buildTimelineItem(item, index, index == roadmapList.length - 1, isDark);
          },
        ),
        ...
        ElevatedButton(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Roadmap saved to your library!')),
            );
          ...
          child: const Text('CONFIRM & SAVE EXPLORATION', 
  ...
  Widget _buildTimelineItem(Map<String, dynamic> item, int index, bool isLast, bool isDark) {
        ...
        Column(
          children: [
            Container(
              ...
              height: 32,
              decoration: BoxDecoration(
                color: isDark ? const Color(0xFF6C63FF).withOpacity(0.2) : Colors.white,
                shape: BoxShape.circle,
            ...
            if (!isLast)
              Container(
                width: 2,
                height: 120, // Approximate height to simulate continuity
